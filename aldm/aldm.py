...
class AnimateLDM(LatentDiffusion):
    ...
    def sample_log(self, cond, batch_size, ddim, ddim_steps, **kwargs):
        ...
        b, c, h, w = cond["img_reference"].shape
    ...
    def configure_optimizers(self):
        ...
        params = list(self.reference_model.parameters()) + \
    ...
    def low_vram_shift(self, is_diffusing):
        if is_diffusing:
            ...
            self.reference_model = self.reference_model.cuda()
            ...
            self.pose_model = self.pose_model.cpu()
